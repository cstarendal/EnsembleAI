...
function AnswerDisplay({ answer }: AnswerDisplayProps): JSX.Element {
  if (!answer) {
    return (
      <div className="text-center text-muted-foreground p-lg">
  ...
  return (
    <div className="bg-card p-lg rounded-lg shadow-card">
      <h2 className="text-xl font-bold text-foreground mb-md">Research Answer</h2>
